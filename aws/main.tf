...
resource "aws_eks_addon" "ebs_csi" {
  ...
  addon_version               = "v1.25.0-eksbuild.1" # Specify a compatible version
...
resource "helm_release" "cluster_autoscaler" {
  ...
  # Set image for ARM compatibility if using ARM instances
  set {
    name  = "image.tag"
    value = "v1.28.0" # Match with your Kubernetes version (1.28)
  }
